...
- все блоки должны иметь фигурные скобки, даже если можно написать выражение без фигурных скобок
...
- Редактор двойного назначения
- Предназначен для создания префабов сущностей, которые будут использоваться в игре
- Предназначен для создания пользовательских блупринтов для строительства в игре
- Игру можно открыть в режиме редактора блупринтов 
- Собирается упрощённая версия игрового мира
- Открывается режим редактирования нового префаба (условный untitled)
- На "сцене" есть виртуальная точка условного "центра" объекта(0,0), она визуально отображена красной точкой
- На сцене появляется одна фигура - треугольник, в центре
- У каждой фигуры выделены вершины
- Вершину можно перемещать
- Вершины выделены синим цветом
- У каждой фигуры есть рёбра между вершинами
- Вершины и рёбра реагируют на ховер(то есть меняют цвет на ховер)
- Зажав ЛКМ над вершиной и переместив мышь - вершина перемещается вслед за мышью
- Вершина не может переместиться так, чтобы какое-либо ребро меша пересекло другое ребро
- Зажав лкм внутри рёбер и переместив мышь - перемещается весь меш
- Нажатие на ПКМ во время Ховера над точкой - удаляет точку
- Нажатие и удержание пкм во время ховера над всем остальным - двигает камеру как в Figma
- Данная функциональность должна быть реализована в соответствии с текущими системами, чтобы легко переиспользовать логику в основной игре